...
**
** Created: Fri Dec 21 10:08:46 2012
...
void Moviesoap::PreferencesWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        PreferencesWin *_t = static_cast<PreferencesWin *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData Moviesoap::PreferencesWin::staticMetaObjectExtraData = {
...
const QMetaObject Moviesoap::PreferencesWin::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_Moviesoap__PreferencesWin,
      qt_meta_data_Moviesoap__PreferencesWin, &staticMetaObjectExtraData }
};
